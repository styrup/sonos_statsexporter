...
func init() {
        ...
        mycol := SonosCollector{sonosuniots: sonss}
...
type SonosCollector struct {
        sonosuniots []sonosUnit
}

// Describe implements Prometheus.Collector.
func (c SonosCollector) Describe(ch chan<- *prometheus.Desc) {
        ch <- collectionDuration

}

// Collect implements Prometheus.Collector.
func (c SonosCollector) Collect(ch chan<- prometheus.Metric) {
        start := time.Now()
